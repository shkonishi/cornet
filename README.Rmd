...
fp <- system.file("extdata/nfpkm_1000.txt", package = "cornet")
...
```{r}
res.cd <- dycutdf(dat = dat, distm = "abscorrelation", clm = "average",
...
#### corgraphの結果をまとめて描画する場合
```{r fig.width=12, fig.height=6}
par(mfrow=c(2,4))
invisible(lapply(cl_gs[-1], function(x)igplot(ig = x, v.s = 7, v.l = NA)))
...
```{r}
res.hub <- gethub(g = cl_g[[3]], com_fun = "cluster_louvain")
